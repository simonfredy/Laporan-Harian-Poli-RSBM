...
<body>
    ...
    <table class="table table-bordered">
       ...
       <?php           
            ...
            echo "<td>UNIT RADIOLOGI</td>";

            // UNIT RADIOLOGI UMUM BARU
            while ($row_radiologiumumlbru = $hasil_radiologiumumlbru->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologiumumlbru['RADIOLOGIUMUMLBRU']."</td>";                
            }
            while ($row_radiologiumumpbru = $hasil_radiologiumumpbru->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologiumumpbru['RADIOLOGIUMUMPBRU']."</td>";                
            }

            // UNIT RADIOLOGI UMUM LAMA
            while ($row_radiologiumumllma = $hasil_radiologiumumllma->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologiumumllma['RADIOLOGIUMUMLLMA']."</td>";                
            }
            while ($row_radiologiumumplma = $hasil_radiologiumumplma->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologiumumplma['RADIOLOGIUMUMPLMA']."</td>";                
            }

            // UNIT RADIOLOGI BPJS BARU
            while ($row_radiologibpjslbru = $hasil_radiologibpjslbru->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologibpjslbru['RADIOLOGIBPJSLBRU']."</td>";                
            }
            while ($row_radiologibpjspbru = $hasil_radiologibpjspbru->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologibpjspbru['RADIOLOGIBPJSPBRU']."</td>";                
            }

            // UNIT RADIOLOGI BPJS LAMA
            while ($row_radiologibpjsllma = $hasil_radiologibpjsllma->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologibpjsllma['RADIOLOGIBPJSLLMA']."</td>";                
            }
            while ($row_radiologibpjsplma = $hasil_radiologibpjsplma->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologibpjsplma['RADIOLOGIBPJSPLMA']."</td>";                
            }

            // UNIT RADIOLOGI JASA RAHARJA BARU
            while ($row_radiologijasaraharjalbru = $hasil_radiologijasaraharjalbru->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologijasaraharjalbru['RADIOLOGIJASARAHARJALBRU']."</td>";                
            }
            while ($row_radiologijasaraharjapbru = $hasil_radiologijasaraharjapbru->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologijasaraharjapbru['RADIOLOGIJASARAHARJAPBRU']."</td>";                
            }

            // UNIT RADIOLOGI JASA RAHARJA LAMA
            while ($row_radiologijasaraharjallma = $hasil_radiologijasaraharjallma->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologijasaraharjallma['RADIOLOGIJASARAHARJALLMA']."</td>";                
            }
            while ($row_radiologijasaraharjaplma = $hasil_radiologijasaraharjaplma->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologijasaraharjaplma['RADIOLOGIJASARAHARJAPLMA']."</td>";                
            }
                
            // UNIT RADIOLOGI
            while ($row_radiologitotal = $hasil_radiologitotal->fetch_assoc()) {
                echo "<td align='center'>".$row_radiologitotal['RADIOLOGITOTAL']."</td>";
            }
            ...
            // UNIT CSSD
            echo "<tr>";
            echo "<td align='center'>39</td>";
            echo "<td>UNIT CSSD</td>";

            // UNIT CSSD UMUM BARU
            while ($row_cssdumumlbru = $hasil_cssdumumlbru->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdumumlbru['CSSDUMUMLBRU']."</td>";                
            }
            while ($row_cssdumumpbru = $hasil_cssdumumpbru->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdumumpbru['CSSDUMUMPBRU']."</td>";                
            }

            // UNIT CSSD UMUM LAMA
            while ($row_cssdumumllma = $hasil_cssdumumllma->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdumumllma['CSSDUMUMLLMA']."</td>";                
            }
            while ($row_cssdumumplma = $hasil_cssdumumplma->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdumumplma['CSSDUMUMPLMA']."</td>";                
            }

            // UNIT CSSD BPJS BARU
            while ($row_cssdbpjslbru = $hasil_cssdbpjslbru->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdbpjslbru['CSSDBPJSLBRU']."</td>";                
            }
            while ($row_cssdbpjspbru = $hasil_cssdbpjspbru->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdbpjspbru['CSSDBPJSPBRU']."</td>";                
            }

            // UNIT CSSD BPJS LAMA
            while ($row_cssdbpjsllma = $hasil_cssdbpjsllma->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdbpjsllma['CSSDBPJSLLMA']."</td>";                
            }
            while ($row_cssdbpjsplma = $hasil_cssdbpjsplma->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdbpjsplma['CSSDBPJSPLMA']."</td>";                
            }

            // UNIT CSSD JASA RAHARJA BARU
            while ($row_cssdjasaraharjalbru = $hasil_cssdjasaraharjalbru->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdjasaraharjalbru['CSSDJASARAHARJALBRU']."</td>";                
            }
            while ($row_cssdjasaraharjapbru = $hasil_cssdjasaraharjapbru->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdjasaraharjapbru['CSSDJASARAHARJAPBRU']."</td>";                
            }

            // UNIT CSSD JASA RAHARJA LAMA
            while ($row_cssdjasaraharjallma = $hasil_cssdjasaraharjallma->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdjasaraharjallma['CSSDJASARAHARJALLMA']."</td>";                
            }
            while ($row_cssdjasaraharjaplma = $hasil_cssdjasaraharjaplma->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdjasaraharjaplma['CSSDJASARAHARJAPLMA']."</td>";                
            }
                
            // UNIT CSSD
            while ($row_cssdtotal = $hasil_cssdtotal->fetch_assoc()) {
                echo "<td align='center'>".$row_cssdtotal['CSSDTOTAL']."</td>";
            }
            ...
            echo "<td>INSTALASI FARMASI</td>";

            // INSTALASI FARMASI UMUM BARU
            while ($row_farmasiumumlbru = $hasil_farmasiumumlbru->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasiumumlbru['FARMASIUMUMLBRU']."</td>";                
            }
            while ($row_farmasiumumpbru = $hasil_farmasiumumpbru->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasiumumpbru['FARMASIUMUMPBRU']."</td>";                
            }

            // INSTALASI FARMASI UMUM LAMA
            while ($row_farmasiumumllma = $hasil_farmasiumumllma->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasiumumllma['FARMASIUMUMLLMA']."</td>";                
            }
            while ($row_farmasiumumplma = $hasil_farmasiumumplma->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasiumumplma['FARMASIUMUMPLMA']."</td>";                
            }

            // INSTALASI FARMASI BPJS BARU
            while ($row_farmasibpjslbru = $hasil_farmasibpjslbru->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasibpjslbru['FARMASIBPJSLBRU']."</td>";                
            }
            while ($row_farmasibpjspbru = $hasil_farmasibpjspbru->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasibpjspbru['FARMASIBPJSPBRU']."</td>";                
            }

            // INSTALASI FARMASI BPJS LAMA
            while ($row_farmasibpjsllma = $hasil_farmasibpjsllma->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasibpjsllma['FARMASIBPJSLLMA']."</td>";                
            }
            while ($row_farmasibpjsplma = $hasil_farmasibpjsplma->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasibpjsplma['FARMASIBPJSPLMA']."</td>";                
            }

            // INSTALASI FARMASI JASA RAHARJA BARU
            while ($row_farmasijasaraharjalbru = $hasil_farmasijasaraharjalbru->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasijasaraharjalbru['FARMASIJASARAHARJALBRU']."</td>";                
            }
            while ($row_farmasijasaraharjapbru = $hasil_farmasijasaraharjapbru->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasijasaraharjapbru['FARMASIJASARAHARJAPBRU']."</td>";                
            }

            // INSTALASI FARMASI JASA RAHARJA LAMA
            while ($row_farmasijasaraharjallma = $hasil_farmasijasaraharjallma->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasijasaraharjallma['FARMASIJASARAHARJALLMA']."</td>";                
            }
            while ($row_farmasijasaraharjaplma = $hasil_farmasijasaraharjaplma->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasijasaraharjaplma['FARMASIJASARAHARJAPLMA']."</td>";                
            }
                
            // INSTALASI FARMASI
            while ($row_farmasitotal = $hasil_farmasitotal->fetch_assoc()) {
                echo "<td align='center'>".$row_farmasitotal['FARMASITOTAL']."</td>";
            }
            ...
            echo "<td>INSTALASI NEONATUS</td>";

            // 	INSTALASI NEONATUS UMUM BARU
            while ($row_neonatusumumlbru = $hasil_neonatusumumlbru->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusumumlbru['NEONATUSUMUMLBRU']."</td>";                
            }
            while ($row_neonatusumumpbru = $hasil_neonatusumumpbru->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusumumpbru['NEONATUSUMUMPBRU']."</td>";                
            }

            // 	INSTALASI NEONATUS UMUM LAMA
            while ($row_neonatusumumllma = $hasil_neonatusumumllma->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusumumllma['NEONATUSUMUMLLMA']."</td>";                
            }
            while ($row_neonatusumumplma = $hasil_neonatusumumplma->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusumumplma['NEONATUSUMUMPLMA']."</td>";                
            }

            // 	INSTALASI NEONATUS BPJS BARU
            while ($row_neonatusbpjslbru = $hasil_neonatusbpjslbru->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusbpjslbru['NEONATUSBPJSLBRU']."</td>";                
            }
            while ($row_neonatusbpjspbru = $hasil_neonatusbpjspbru->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusbpjspbru['NEONATUSBPJSPBRU']."</td>";                
            }

            // 	INSTALASI NEONATUS BPJS LAMA
            while ($row_neonatusbpjsllma = $hasil_neonatusbpjsllma->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusbpjsllma['NEONATUSBPJSLLMA']."</td>";                
            }
            while ($row_neonatusbpjsplma = $hasil_neonatusbpjsplma->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusbpjsplma['NEONATUSBPJSPLMA']."</td>";                
            }

            // 	INSTALASI NEONATUS JASA RAHARJA BARU
            while ($row_neonatusjasaraharjalbru = $hasil_neonatusjasaraharjalbru->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusjasaraharjalbru['NEONATUSJASARAHARJALBRU']."</td>";                
            }
            while ($row_neonatusjasaraharjapbru = $hasil_neonatusjasaraharjapbru->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusjasaraharjapbru['NEONATUSJASARAHARJAPBRU']."</td>";                
            }

            // 	INSTALASI NEONATUS JASA RAHARJA LAMA
            while ($row_neonatusjasaraharjallma = $hasil_neonatusjasaraharjallma->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusjasaraharjallma['NEONATUSJASARAHARJALLMA']."</td>";                
            }
            while ($row_neonatusjasaraharjaplma = $hasil_neonatusjasaraharjaplma->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatusjasaraharjaplma['NEONATUSJASARAHARJAPLMA']."</td>";                
            }
                
            // 	INSTALASI NEONATUS
            while ($row_neonatustotal = $hasil_neonatustotal->fetch_assoc()) {
                echo "<td align='center'>".$row_neonatustotal['NEONATUSTOTAL']."</td>";
            }
            ...
            echo "<td>INSTALASI INTENSIVE CARE UNIT</td>";

            // 	INSTALASI INTENSIVE CARE UNIT UMUM BARU
            while ($row_icuumumlbru = $hasil_icuumumlbru->fetch_assoc()) {
                echo "<td align='center'>".$row_icuumumlbru['ICUUMUMLBRU']."</td>";                
            }
            while ($row_icuumumpbru = $hasil_icuumumpbru->fetch_assoc()) {
                echo "<td align='center'>".$row_icuumumpbru['ICUUMUMPBRU']."</td>";                
            }

            // 	INSTALASI INTENSIVE CARE UNIT UMUM LAMA
            while ($row_icuumumllma = $hasil_icuumumllma->fetch_assoc()) {
                echo "<td align='center'>".$row_icuumumllma['ICUUMUMLLMA']."</td>";                
            }
            while ($row_icuumumplma = $hasil_icuumumplma->fetch_assoc()) {
                echo "<td align='center'>".$row_icuumumplma['ICUUMUMPLMA']."</td>";                
            }

            // 	INSTALASI INTENSIVE CARE UNIT BPJS BARU
            while ($row_icubpjslbru = $hasil_icubpjslbru->fetch_assoc()) {
                echo "<td align='center'>".$row_icubpjslbru['ICUBPJSLBRU']."</td>";                
            }
            while ($row_icubpjspbru = $hasil_icubpjspbru->fetch_assoc()) {
                echo "<td align='center'>".$row_icubpjspbru['ICUBPJSPBRU']."</td>";                
            }

            // 	INSTALASI INTENSIVE CARE UNIT BPJS LAMA
            while ($row_icubpjsllma = $hasil_icubpjsllma->fetch_assoc()) {
                echo "<td align='center'>".$row_icubpjsllma['ICUBPJSLLMA']."</td>";                
            }
            while ($row_icubpjsplma = $hasil_icubpjsplma->fetch_assoc()) {
                echo "<td align='center'>".$row_icubpjsplma['ICUBPJSPLMA']."</td>";                
            }

            // 	INSTALASI INTENSIVE CARE UNIT JASA RAHARJA BARU
            while ($row_icujasaraharjalbru = $hasil_icujasaraharjalbru->fetch_assoc()) {
                echo "<td align='center'>".$row_icujasaraharjalbru['ICUJASARAHARJALBRU']."</td>";                
            }
            while ($row_icujasaraharjapbru = $hasil_icujasaraharjapbru->fetch_assoc()) {
                echo "<td align='center'>".$row_icujasaraharjapbru['ICUJASARAHARJAPBRU']."</td>";                
            }

            // 	INSTALASI INTENSIVE CARE UNIT JASA RAHARJA LAMA
            while ($row_icujasaraharjallma = $hasil_icujasaraharjallma->fetch_assoc()) {
                echo "<td align='center'>".$row_icujasaraharjallma['ICUJASARAHARJALLMA']."</td>";                
            }
            while ($row_icujasaraharjaplma = $hasil_icujasaraharjaplma->fetch_assoc()) {
                echo "<td align='center'>".$row_icujasaraharjaplma['ICUJASARAHARJAPLMA']."</td>";                
            }
                
            // 	INSTALASI INTENSIVE CARE UNIT
            while ($row_icutotal = $hasil_icutotal->fetch_assoc()) {
                echo "<td align='center'>".$row_icutotal['ICUTOTAL']."</td>";
            }
            ...
            echo "<td>INSTALASI KAMAR BEDAH</td>";
        
            //  INSTALASI KAMAR BEDAH UMUM BARU
            while ($row_kmrbedahumumlbru = $hasil_kmrbedahumumlbru->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahumumlbru['KMRBEDAHUMUMLBRU']."</td>";                
            }
            while ($row_kmrbedahumumpbru = $hasil_kmrbedahumumpbru->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahumumpbru['KMRBEDAHUMUMPBRU']."</td>";                
            }

            //  INSTALASI KAMAR BEDAH UMUM LAMA
            while ($row_kmrbedahumumllma = $hasil_kmrbedahumumllma->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahumumllma['KMRBEDAHUMUMLLMA']."</td>";                
            }
            while ($row_kmrbedahumumplma = $hasil_kmrbedahumumplma->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahumumplma['KMRBEDAHUMUMPLMA']."</td>";                
            }

            //  INSTALASI KAMAR BEDAH BPJS BARU
            while ($row_kmrbedahbpjslbru = $hasil_kmrbedahbpjslbru->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahbpjslbru['KMRBEDAHBPJSLBRU']."</td>";                
            }
            while ($row_kmrbedahbpjspbru = $hasil_kmrbedahbpjspbru->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahbpjspbru['KMRBEDAHBPJSPBRU']."</td>";                
            }

            //  INSTALASI KAMAR BEDAH BPJS LAMA
            while ($row_kmrbedahbpjsllma = $hasil_kmrbedahbpjsllma->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahbpjsllma['KMRBEDAHBPJSLLMA']."</td>";                
            }
            while ($row_kmrbedahbpjsplma = $hasil_kmrbedahbpjsplma->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahbpjsplma['KMRBEDAHBPJSPLMA']."</td>";                
            }

            //  INSTALASI KAMAR BEDAH JASA RAHARJA BARU
            while ($row_kmrbedahjasaraharjalbru = $hasil_kmrbedahjasaraharjalbru->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahjasaraharjalbru['KMRBEDAHJASARAHARJALBRU']."</td>";                
            }
            while ($row_kmrbedahjasaraharjapbru = $hasil_kmrbedahjasaraharjapbru->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahjasaraharjapbru['KMRBEDAHJASARAHARJAPBRU']."</td>";                
            }

            //  INSTALASI KAMAR BEDAH JASA RAHARJA LAMA
            while ($row_kmrbedahjasaraharjallma = $hasil_kmrbedahjasaraharjallma->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahjasaraharjallma['KMRBEDAHJASARAHARJALLMA']."</td>";                
            }
            while ($row_kmrbedahjasaraharjaplma = $hasil_kmrbedahjasaraharjaplma->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahjasaraharjaplma['KMRBEDAHJASARAHARJAPLMA']."</td>";                
            }
                
            //  INSTALASI KAMAR BEDAH
            while ($row_kmrbedahtotal = $hasil_kmrbedahtotal->fetch_assoc()) {
                echo "<td align='center'>".$row_kmrbedahtotal['KMRBEDAHTOTAL']."</td>";
            }
            ...
            echo "<td>INSTALSAI LABORATORIUM</td>";

            //  INSTALSAI LABORATORIUM UMUM BARU
            while ($row_labumumlbru = $hasil_labumumlbru->fetch_assoc()) {
                echo "<td align='center'>".$row_labumumlbru['LABUMUMLBRU']."</td>";                
            }
            while ($row_labumumpbru = $hasil_labumumpbru->fetch_assoc()) {
                echo "<td align='center'>".$row_labumumpbru['LABUMUMPBRU']."</td>";                
            }

            //  INSTALSAI LABORATORIUM UMUM LAMA
            while ($row_labumumllma = $hasil_labumumllma->fetch_assoc()) {
                echo "<td align='center'>".$row_labumumllma['LABUMUMLLMA']."</td>";                
            }
            while ($row_labumumplma = $hasil_labumumplma->fetch_assoc()) {
                echo "<td align='center'>".$row_labumumplma['LABUMUMPLMA']."</td>";                
            }

            //  INSTALSAI LABORATORIUM BPJS BARU
            while ($row_labbpjslbru = $hasil_labbpjslbru->fetch_assoc()) {
                echo "<td align='center'>".$row_labbpjslbru['LABBPJSLBRU']."</td>";                
            }
            while ($row_labbpjspbru = $hasil_labbpjspbru->fetch_assoc()) {
                echo "<td align='center'>".$row_labbpjspbru['LABBPJSPBRU']."</td>";                
            }

            //  INSTALSAI LABORATORIUM BPJS LAMA
            while ($row_labbpjsllma = $hasil_labbpjsllma->fetch_assoc()) {
                echo "<td align='center'>".$row_labbpjsllma['LABBPJSLLMA']."</td>";                
            }
            while ($row_labbpjsplma = $hasil_labbpjsplma->fetch_assoc()) {
                echo "<td align='center'>".$row_labbpjsplma['LABBPJSPLMA']."</td>";                
            }

            //  INSTALSAI LABORATORIUM JASA RAHARJA BARU
            while ($row_labjasaraharjalbru = $hasil_labjasaraharjalbru->fetch_assoc()) {
                echo "<td align='center'>".$row_labjasaraharjalbru['LABJASARAHARJALBRU']."</td>";                
            }
            while ($row_labjasaraharjapbru = $hasil_labjasaraharjapbru->fetch_assoc()) {
                echo "<td align='center'>".$row_labjasaraharjapbru['LABJASARAHARJAPBRU']."</td>";                
            }

            //  INSTALSAI LABORATORIUM JASA RAHARJA LAMA
            while ($row_labjasaraharjallma = $hasil_labjasaraharjallma->fetch_assoc()) {
                echo "<td align='center'>".$row_labjasaraharjallma['LABJASARAHARJALLMA']."</td>";                
            }
            while ($row_labjasaraharjaplma = $hasil_labjasaraharjaplma->fetch_assoc()) {
                echo "<td align='center'>".$row_labjasaraharjaplma['LABJASARAHARJAPLMA']."</td>";                
            }
                
            //  INSTALSAI LABORATORIUM
            while ($row_labtotal = $hasil_labtotal->fetch_assoc()) {
                echo "<td align='center'>".$row_labtotal['LABTOTAL']."</td>";
            }
            ...
            echo "<td>INSTALASI NICU</td>";

            //  INSTALASI NICU UMUM BARU
            while ($row_nicuumumlbru = $hasil_nicuumumlbru->fetch_assoc()) {
                echo "<td align='center'>".$row_nicuumumlbru['NICUUMUMLBRU']."</td>";                
            }
            while ($row_nicuumumpbru = $hasil_nicuumumpbru->fetch_assoc()) {
                echo "<td align='center'>".$row_nicuumumpbru['NICUUMUMPBRU']."</td>";                
            }

            //  INSTALASI NICU UMUM LAMA
            while ($row_nicuumumllma = $hasil_nicuumumllma->fetch_assoc()) {
                echo "<td align='center'>".$row_nicuumumllma['NICUUMUMLLMA']."</td>";                
            }
            while ($row_nicuumumplma = $hasil_nicuumumplma->fetch_assoc()) {
                echo "<td align='center'>".$row_nicuumumplma['NICUUMUMPLMA']."</td>";                
            }

            //  INSTALASI NICU BPJS BARU
            while ($row_nicubpjslbru = $hasil_nicubpjslbru->fetch_assoc()) {
                echo "<td align='center'>".$row_nicubpjslbru['NICUBPJSLBRU']."</td>";                
            }
            while ($row_nicubpjspbru = $hasil_nicubpjspbru->fetch_assoc()) {
                echo "<td align='center'>".$row_nicubpjspbru['NICUBPJSPBRU']."</td>";                
            }

            //  INSTALASI NICU BPJS LAMA
            while ($row_nicubpjsllma = $hasil_nicubpjsllma->fetch_assoc()) {
                echo "<td align='center'>".$row_nicubpjsllma['NICUBPJSLLMA']."</td>";                
            }
            while ($row_nicubpjsplma = $hasil_nicubpjsplma->fetch_assoc()) {
                echo "<td align='center'>".$row_nicubpjsplma['NICUBPJSPLMA']."</td>";                
            }

            //  INSTALASI NICU JASA RAHARJA BARU
            while ($row_nicujasaraharjalbru = $hasil_nicujasaraharjalbru->fetch_assoc()) {
                echo "<td align='center'>".$row_nicujasaraharjalbru['NICUJASARAHARJALBRU']."</td>";                
            }
            while ($row_nicujasaraharjapbru = $hasil_nicujasaraharjapbru->fetch_assoc()) {
                echo "<td align='center'>".$row_nicujasaraharjapbru['NICUJASARAHARJAPBRU']."</td>";                
            }

            //  INSTALASI NICU JASA RAHARJA LAMA
            while ($row_nicujasaraharjallma = $hasil_nicujasaraharjallma->fetch_assoc()) {
                echo "<td align='center'>".$row_nicujasaraharjallma['NICUJASARAHARJALLMA']."</td>";                
            }
            while ($row_nicujasaraharjaplma = $hasil_nicujasaraharjaplma->fetch_assoc()) {
                echo "<td align='center'>".$row_nicujasaraharjaplma['NICUJASARAHARJAPLMA']."</td>";                
            }
                
            //  INSTALASI NICU
            while ($row_nicutotal = $hasil_nicutotal->fetch_assoc()) {
                echo "<td align='center'>".$row_nicutotal['NICUTOTAL']."</td>";
            }
            ...
            echo "<td>INSTALASI DOKPOL</td>";

            //  INSTALASI DOKPOL UMUM BARU
            while ($row_dokpolumumlbru = $hasil_dokpolumumlbru->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpolumumlbru['DOKPOLUMUMLBRU']."</td>";                
            }
            while ($row_dokpolumumpbru = $hasil_dokpolumumpbru->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpolumumpbru['DOKPOLUMUMPBRU']."</td>";                
            }

            //  INSTALASI DOKPOL UMUM LAMA
            while ($row_dokpolumumllma = $hasil_dokpolumumllma->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpolumumllma['DOKPOLUMUMLLMA']."</td>";                
            }
            while ($row_dokpolumumplma = $hasil_dokpolumumplma->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpolumumplma['DOKPOLUMUMPLMA']."</td>";                
            }

            //  INSTALASI NICU BPJS BARU
            while ($row_dokpolbpjslbru = $hasil_dokpolbpjslbru->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpolbpjslbru['DOKPOLBPJSLBRU']."</td>";                
            }
            while ($row_dokpolbpjspbru = $hasil_dokpolbpjspbru->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpolbpjspbru['DOKPOLBPJSPBRU']."</td>";                
            }

            //  INSTALASI DOKPOL BPJS LAMA
            while ($row_dokpolbpjsllma = $hasil_dokpolbpjsllma->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpolbpjsllma['DOKPOLBPJSLLMA']."</td>";                
            }
            while ($row_dokpolbpjsplma = $hasil_dokpolbpjsplma->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpolbpjsplma['DOKPOLBPJSPLMA']."</td>";                
            }

            //  INSTALASI DOKPOL JASA RAHARJA BARU
            while ($row_dokpoljasaraharjalbru = $hasil_dokpoljasaraharjalbru->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpoljasaraharjalbru['DOKPOLJASARAHARJALBRU']."</td>";                
            }
            while ($row_dokpoljasaraharjapbru = $hasil_dokpoljasaraharjapbru->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpoljasaraharjapbru['DOKPOLJASARAHARJAPBRU']."</td>";                
            }

            //  INSTALASI DOKPOL JASA RAHARJA LAMA
            while ($row_dokpoljasaraharjallma = $hasil_dokpoljasaraharjallma->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpoljasaraharjallma['DOKPOLJASARAHARJALLMA']."</td>";                
            }
            while ($row_dokpoljasaraharjaplma = $hasil_dokpoljasaraharjaplma->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpoljasaraharjaplma['DOKPOLJASARAHARJAPLMA']."</td>";                
            }
                
            //  INSTALASI DOKPOL
            while ($row_dokpoltotal = $hasil_dokpoltotal->fetch_assoc()) {
                echo "<td align='center'>".$row_dokpoltotal['DOKPOLTOTAL']."</td>";
            }
